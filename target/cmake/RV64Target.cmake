...
MACRO(_SETTINGS_PRE)
    SET(_LIB_TUMEDA ${_TOOLCHAIN_DIR}/rv64_tumeda)
    SET(_INCLUDES
    )
...
MACRO(ADD_EXECUTABLE__INTERNAL TARGET_NAME ADD_PLATFORM_FILES)
    _SETTINGS_PRE()
    ...
    ENDIF()
    IF(NOT _ROM_SIZE)
        SET(_ROM_SIZE 0x800000)
    ENDIF()
    IF(NOT _RAM_START)
        SET(_RAM_START 0x800000)
    ENDIF()
    IF(NOT _RAM_SIZE)
        SET(_RAM_SIZE 0x800000)
    ENDIF()
    IF(NOT _STACK_SIZE)
    ...
    IF(${ADD_PLATFORM_FILES})
        LIST(APPEND SRC_FILES
            ${_LIB_TUMEDA}/crt0.riscv.S
            ${_LIB_TUMEDA}/syscalls.c
        )
    ENDIF()
    ...
    SET_TARGET_PROPERTIES(${TARGET_NAME} PROPERTIES LINK_DEPENDS ${_LIB_TUMEDA}/link.ld)
...
MACRO(ADD_EXECUTABLE_ TARGET_NAME)
    ADD_EXECUTABLE__INTERNAL(${TARGET_NAME} ON ${ARGN})
ENDMACRO()

MACRO(ADD_EXECUTABLE__RAW TARGET_NAME)
    ADD_EXECUTABLE__INTERNAL(${TARGET_NAME} OFF ${ARGN})
ENDMACRO()
